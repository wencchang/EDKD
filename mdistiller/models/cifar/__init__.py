...
cifar_model_dict = {
    ...
    "resnet56": (
        ...
        'F:/wenchi/mdistiller/mdistiller/models/cifar/download_ckpts/cifar_teachers/resnet56_vanilla/ckpt_epoch_240.pth',

    ),
    "resnet110": (
        resnet110,
        'F:/wenchi/mdistiller/mdistiller/models/cifar/download_ckpts/cifar_teachers/resnet110_vanilla/ckpt_epoch_240.pth',
    ),
    "resnet32x4": (
        resnet32x4,
        # cifar100_model_prefix + "resnet32x4_vanilla/ckpt_epoch_240.pth",
        # 'F:/wenchi/mdistiller/cifar_teachers/resnet32x4_vanilla/ckpt_epoch_240.pth'
        "F:/wenchi/mdistiller/mdistiller/models/cifar/download_ckpts/cifar_teachers/resnet32x4_vanilla/ckpt_epoch_240.pth",
    ),
    "ResNet50": (
        ResNet50,
        # cifar100_model_prefix + "ResNet50_vanilla/ckpt_epoch_240.pth",
        'F:/wenchi/mdistiller/mdistiller/models/cifar/download_ckpts/cifar_teachers/ResNet50_vanilla/ckpt_epoch_240.pth',
    ),
    "wrn_40_2": (
        wrn_40_2,
        # cifar100_model_prefix + "wrn_40_2_vanilla/ckpt_epoch_240.pth",
        'F:/wenchi/mdistiller/mdistiller/models/cifar/download_ckpts/cifar_teachers/wrn_40_2_vanilla/ckpt_epoch_240.pth',
    ),
