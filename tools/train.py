...
import sys
sys.path.append('F:/wenchi/mdistiller')
...
def main(cfg, resume, opts):
    ...
    if cfg.LOG.WANDB:
        try:
            ...
            wandb.init(project=cfg.EXPERIMENT.PROJECT, entity='titan-shuo', name="alpha_beta3", tags=tags)
        except:
    ...
    # distillation
        ...
        if cfg.DATASET.TYPE == "imagenet":
            ...
            model_teacher.load_state_dict(load_checkpoint('F:/wenchi/mdistiller/mdistiller/models/cifar/download_ckpts/cifar_teachers/resnet32x4_vanilla/ckpt_epoch_240.pth')["model"])
